...
let UserResolver = class UserResolver {
    register(options, { db, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const hashedPassword = yield argon2_1.default.hash(options.password, {
                saltLength: 12,
            });
            const user = db.create(User_1.User, {
                username: options.username,
                password: hashedPassword,
            });
            yield db.persistAndFlush(user);
            req.session.userId = user.id;
            return { user };
        });
    }
    login(options, { db, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield db.findOne(User_1.User, { username: options.username });
            if (user === null) {
    ...
    me({ db, req }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield db.findOne(User_1.User, { id: req.session.userId });
            if (user === null) {
                return { errors: [{ field: "", message: "account not found" }] };
            }
            return { user };
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg("options", { nullable: false })),
